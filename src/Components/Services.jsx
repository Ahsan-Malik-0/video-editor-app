...
function ServiceCard({ service, index }) {
  ...
  return (
    <motion.div
      ...
      className="group bg-[#111111] border border-white/5 p-8 hover:border-[#C9A84C]/40 transition-all duration-400 hover:bg-[#141414]"
    >
      <span className="text-4xl mb-5 block">{service.icon}</span>
      <h3 className="font-cinzel text-white text-lg font-semibold mb-3 group-hover:text-[#C9A84C] transition-colors duration-300">
        {service.title}
      </h3>
...
export default function Services() {
  ...
  return (
    <section id="services" className="bg-[#0A0A0A] py-24 px-6">
